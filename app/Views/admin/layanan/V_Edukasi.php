                    ...
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Rekap Sosialisasi (Informasi dan Edukasi)</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="col-md-4">
                                            <form action="proses_cetak_sosialisasi" method="post" target="_blank">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Layanan Sosialisasi (Informasi dan Edukasi)</h5>
                                    </div>
                                    <div class="card-block table-border-style">
                                        <div class="table-responsive">
                                            <table class="table display" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php $no = 1; ?>
                                                    <?php foreach ($edukasi as $info) : ?>
                                                        <tr>
                                                            <th scope="row"><?= $no++; ?></th>
                                                            <td><?= $info['nama_lembaga']; ?></td>
                                                            <td><?= $info['email']; ?></td>
                                                            <td><?= $info['no_telp']; ?></td>
                                                            <td>
                                                                ...
                                                                <?php } elseif ($info['status'] == 'konfirmasi') { ?>
                                                                    <a href="/konfirmasi_sosialisasi/<?= $info['id_edukasi'] ?>">Konfirmasi</a>
                                                                <?php } ?>
                                                            </td>
                                                            <td>
                                                                <?php if ($info['status'] == 'selesai') { ?>
