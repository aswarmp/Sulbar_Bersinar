                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Rekap Besuk Tahanan</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="col-md-4">
                                            <form action="proses_cetak_Betah" method="post" target="_blank">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php } elseif ($info['status'] == 'konfirmasi') { ?>
                                                                    <a href="/konfirmasi_betah/<?= $info['id_betah'] ?>">Konfirmasi</a>
                                                                <?php } ?>
                                                            </td>
                                                            <td>
                                                                <?php if ($info['status'] == 'selesai') { ?>
