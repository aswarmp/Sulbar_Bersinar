                    ...
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Rekap Surat Keterangan pemeriksaan Narkoba</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="col-md-4">
                                            <form action="proses_cetak_SuketNarkoba" method="post" target="_blank">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Layanan Surat Keterangan pemeriksaan Narkoba</h5>
                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php } elseif ($info['status'] == 'konfirmasi') { ?>
                                                                    <a href="/proses_konfirmasi_suket_narkoba/<?= $info['id_pemeriksaan'] ?>">Konfirmasi</a>
                                                                <?php } ?>
                                                            </td>
                                                            <td>
                                                                <?php if ($info['status'] == 'selesai') { ?>
