                    ...
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Rekap Asessmen Dan Konseling</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="col-md-4">
                                            <form action="proses_cetak_Assesmen" method="post" target="_blank">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Layanan Asessmen Dan Konseling</h5>
                                    </div>
                                    <div class="card-block table-border-style">
                                        <div class="table-responsive">
                                            <table class="table display" id="myTable">
                                                ...
                                                <tbody>
                                                    <?php $no = 1; ?>
                                                    <?php foreach ($asesmen as $info) : ?>
                                                        <tr>
                                                            <th scope="row"><?= $no++; ?></th>
                                                            <td><?= $info['nama']; ?></td>
                                                            <td><?= $info['email']; ?></td>
                                                            <td><?= $info['no_telp']; ?></td>
                                                            <!-- <td><a class="btn btn-default" href="/konfir_asesmen/<?= $info['id_assesment'] ?>"><?= $info['status']; ?></a></td> -->
                                                            <td>
                                                                <?php if ($info['status'] == 'selesai') { ?>
                                                                    <p>Selesai</p>
                                                                <?php } elseif ($info['status'] == 'konfirmasi') { ?>
                                                                    <a href="/konfir_asesmen/<?= $info['id_assesment'] ?>">Konfirmasi</a>
                                                                <?php } ?>
                                                            </td>
                                                            <td>
                                                                <?php if ($info['status'] == 'selesai') { ?>
