                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                        <form action="<?= base_url('Proses_berita'); ?>" method="post" enctype="multipart/form-data">
                                            <?= csrf_field(); ?>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="proses_berita" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="keterangan_berita" rows="3"></textarea>
                                                            <small class="form-text text-muted">Isikan Keterangan berita dengan benar</small>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Tanggal Berita</label>
                                                            <input type="date" class="form-control" name="tangal_berita" placeholder="Tanggal Berita">
                                                            <small class="form-text text-muted">Isikan Tanggal berita dengan benar</small>
                                                        </div>
                                                        <!-- gambar 1 -->
