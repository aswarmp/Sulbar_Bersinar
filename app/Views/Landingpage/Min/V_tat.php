...
<body>
	<div class="wrapper">
		...
		<form action="/Proses_tat" method="post">
			<div id="wizard">
				<h4>Permintaan TAT</h4>
				<hr>
				...
				<div class="form-row">
					...
					<input type="text" name="alamat" class="form-control" placeholder="jalan" style="margin-bottom: 20px">
				</div>
				<div class="form-row">
					<label for="">
						Catatan
				...
				<div class="form-row">
					<input type="hidden" name="jenis_layanan" value="Permintaan TAT" class="form-control" placeholder="Street address" style="margin-bottom: 20px">
				</div>
				<div class="form-row">
