...
<body>
	<div class="wrapper">
		...
		<form action="/Proses_Sosialisasi" method="post" enctype="multipart/form-data">
			<div id="wizard">
				<h4>Informasi Dan Edukasi</h4>
				<hr>
				...
				<div class="form-row">
					...
					<input type="text" name="jumlah_narasumber" class="form-control" style="margin-bottom: 20px">
				</div>
				<div class="form-row">
					<label for="">
						KTP/KK
				...
				<div class="form-row">
					...
					<input type="text" name="catatan" class="form-control" style="margin-bottom: 20px">
				</div>
				<div class="form-row">
					<label for="">
						Tanggal
				...
				<div class="form-row">
					<input type="hidden" name="jenis_layanan" value="Informasi Dan Edukasi">
				</div>
				<div class="form-row">
