...
<body>
	<div class="wrapper">
		...
		<form action="/Proses_Konsul_Dokter" method="post" enctype="multipart/form-data">
			<div id="wizard">
				<!-- <br>
				<br>
				<br>
				<br> -->
				<h4>Permintaan Konsultasi Dokter</h4>
				<hr>
				...
				<div class="form-row">
					<input type="hidden" name="jenis_layanan" value="Konsultasi Dokter" class="form-control" style="margin-bottom: 20px">
				</div>
				<div class="form-row">
					<label for="">
						Tanggal
